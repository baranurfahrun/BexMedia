...
<aside>
    ...
    <nav class="nav-menu">
        ...
        <!-- 1. Insight & Analytics -->
        <?php $insight_files = ['dashboard2.php', 'semua_antrian.php', 'mjkn_antrian.php', 'poli_antrian.php', 'erm.php', 'satu_sehat.php', 'progres_kerja.php', 'slide_pelaporan.php']; ?>
        ...
        <?php $tech_files = ['order_tiket_it_software.php', 'order_tiket_it_hardware.php', 'order_tiket_sarpras.php', 'data_tiket_it_software.php', 'handling_time.php', 'maintenance_rutin.php', 'data_barang_it.php', 'koneksi_bridging.php', 'berita_acara_it.php']; ?>
        <div class="nav-dropdown <?php echo is_group_active($tech_files) ? 'open' : ''; ?>">
            ...
            <div class="dropdown-content">
                ...
                <a href="data_barang_it.php" class="dropdown-item">Inventaris Aset</a>
        ...
        <?php $tte_files = ['buat_tte.php', 'bubuhkan_tte.php', 'bubuhkan_stampel.php', 'cek_tte.php', 'dokumen_tte.php', 'surat_masuk.php', 'surat_keluar.php', 'agenda_direktur.php', 'arsip_digital.php', 'rapat_bulanan.php', 'surat_edaran.php']; ?>
        <div class="nav-dropdown <?php echo is_group_active($tte_files) ? 'open' : ''; ?>">
            ...
            <div class="dropdown-content">
                <a href="bubuhkan_tte.php" class="dropdown-item">Digital Signature</a>
                <a href="bubuhkan_stampel.php" class="dropdown-item">Stempel Digital</a>
        ...
        <?php $sdm_files = ['data_karyawan.php', 'absensi.php', 'jadwal_dinas.php', 'pengajuan_cuti.php', 'izin_keluar.php', 'input_gaji.php', 'data_gaji.php', 'catatan_kerja.php', 'input_kpi.php', 'exit_clearance.php']; ?>
        ...
        <!-- 5. Quality Assurance -->
        <?php $qa_files = ['input_harian.php', 'capaian_imut.php', 'praktek.php', 'wawancara.php', 'hasil_kredensial.php', 'sip_str.php', 'data_dokumen.php', 'master_pokja.php']; ?>
        ...
        <!-- 6. Bex Reports & Audit -->
        <?php $report_files = ['laporan_harian.php', 'laporan_bulanan.php', 'laporan_tahunan.php', 'log_login.php', 'activity_log.php', 'scan_malware.php']; ?>
