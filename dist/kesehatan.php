  ...
  <body>
    <script>
      Swal.fire({
        ...
        confirmButtonText: "<i class=\'fa fa-home\'></i> Kembali ke BexMedia",
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan'])) {
  ...
  if (!is_numeric($nominal) || $nominal <= 0) {
    ...
    $query = mysqli_query($conn, "INSERT INTO kesehatan (nominal) VALUES ('$nominal')");
    if ($query) {
...
$data = mysqli_query($conn, "SELECT * FROM kesehatan ORDER BY id DESC");
?>
...
<div id="app">
  <div class="main-wrapper main-wrapper-1">
    ...
    <div class="main-content">
      <?php 
      $breadcrumb = "Employee Hub / <strong>Kesehatan</strong>";
      include "topbar.php"; 
      ?>
