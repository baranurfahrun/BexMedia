...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan'])) {
  ...
  if (!is_numeric($nominal) || $nominal <= 0) {
    ...
    $query = mysqli_query($conn, "INSERT INTO potongan_bpjs_tk_jp (nominal) VALUES ('$nominal')");
    if ($query) {
      $_SESSION['flash_message'] = "Data berhasil disimpan.";
      header("Location: potongan_bpjs_tk_jp.php");
      exit;
    } else {
...
$data = mysqli_query($conn, "SELECT * FROM potongan_bpjs_tk_jp ORDER BY id DESC");
?>
        ...
        <div class="section-body">
          <div class="card">
            <div class="card-header">
              <h4>Manajemen Potongan BPJS TK JP</h4>
            </div>
            <div class="card-body">
