...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan'])) {
  ...
  if (!is_numeric($nominal) || $nominal <= 0) {
    ...
    $query = mysqli_query($conn, "INSERT INTO gaji_pokok (nominal) VALUES ('$nominal')");
    if ($query) {
      $_SESSION['flash_message'] = "Data berhasil disimpan.";
      header("Location: gaji_pokok.php");
      exit;
    } else {
...
$data = mysqli_query($conn, "SELECT * FROM gaji_pokok ORDER BY id DESC");
?>
...
<div id="app">
  <div class="main-wrapper main-wrapper-1">
    ...
    <div class="main-content">
      <?php 
      $breadcrumb = "Employee Hub / <strong>Gaji Pokok</strong>";
      include "topbar.php"; 
      ?>
                ...
                <div class="tab-pane fade show active" id="input" role="tabpanel">
                  ...
                  <form method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" name="nominal" class="form-control" placeholder="Contoh: 3500000" required>
                    </div>
