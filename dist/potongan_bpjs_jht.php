...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan'])) {
  ...
  if (!is_numeric($nominal) || $nominal <= 0) {
    ...
    $query = mysqli_query($conn, "INSERT INTO potongan_bpjs_jht (nominal) VALUES ('$nominal')");
    if ($query) {
      $_SESSION['flash_message'] = "Data berhasil disimpan.";
      header("Location: potongan_bpjs_jht.php");
      exit;
    } else {
...
$data = mysqli_query($conn, "SELECT * FROM potongan_bpjs_jht ORDER BY id DESC");
?>
...
<div id="app">
  <div class="main-wrapper main-wrapper-1">
    ...
    <div class="main-content">
      <?php 
      $breadcrumb = "Employee Hub / <strong>Potongan Bpjs Jht</strong>";
      include "topbar.php"; 
      ?>
        ...
        <div class="section-body">
          <div class="card">
            <div class="card-header">
              <h4>Manajemen Potongan BPJS JHT</h4>
            </div>
            <div class="card-body">
