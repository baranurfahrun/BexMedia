        ...
        <div class="section-body">
          <div class="card card-ice">
            <div class="card-header bg-white">
              <h4 class="mb-0"><i class="fas fa-code mr-2"></i>Software Service Request</h4>
            </div>
                  ...
                  <form method="POST" action="simpan_tiket_it_software.php" id="form-order-software">
                    ...
                    <div class="row">
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" name="nik" id="nik" class="form-control form-control-ice" value="<?php echo h($nik_user); ?>" readonly style="background: var(--ice-5) !important;">
                      </div>

                      <div class="form-group col-md-4">
                        <label for="nama" class="text-uppercase small font-weight-bold text-muted">Nama</label>
                        <input type="text" name="nama" id="nama" class="form-control form-control-ice" value="<?php echo h($nama_user); ?>" readonly style="background: var(--ice-5) !important;">
                      </div>

                      <div class="form-group col-md-4">
                        <label for="jabatan" class="text-uppercase small font-weight-bold text-muted">Jabatan</label>
                        <input type="text" name="jabatan" id="jabatan" class="form-control form-control-ice" value="<?php echo h($jabatan_user); ?>" readonly style="background: var(--ice-5) !important;">
                      </div>
                      ...
                      <div class="form-group col-md-4">
                        <label for="kategori" class="text-uppercase small font-weight-bold text-muted">Kategori Software</label>
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <textarea name="kendala" class="form-control form-control-ice" rows="4" required placeholder="Jelaskan detail kendala atau permintaan Anda..."></textarea>
                      </div>
                    </div>
