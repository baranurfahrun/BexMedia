              ...
              <div class="card-body">
                ...
                <form method="POST" class="form-inline mb-3">
                  <div class="form-group mr-2" style="flex: 1;">
                    <input type="text" name="nama_kategori" class="form-control w-100" placeholder="Nama kategori hardware baru" required />
                  </div>
                ...
                if (isset($_POST['simpan'])) {
                  ...
                  $insert = mysqli_query($conn, "INSERT INTO kategori_hardware (nama_kategori) VALUES ('$nama_kategori')");
                  if ($insert) {
                    $_SESSION['flash_message'] = "Kategori berhasil ditambahkan.";
                    echo "<script>location.href='kategori_hardware.php';</script>";
                    exit;
                  } else {
                ...
                // Hitung total data
                $totalQuery = "SELECT COUNT(*) as total FROM kategori_hardware";
                if (!empty($keyword)) {
                ...
                $query = "SELECT * FROM kategori_hardware";
                if (!empty($keyword)) {
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-sm table-hover">
                    ...
                    <tbody>
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo "<td class='text-center'>
                                  <a href='kategori_hardware.php?hapus={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Hapus kategori ini?\")'>
                      ...
                      if (isset($_GET['hapus'])) {
                        $id = (int)$_GET['hapus'];
                        mysqli_query($conn, "DELETE FROM kategori_hardware WHERE id = $id");
