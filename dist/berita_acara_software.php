...
<body>
          ...
          <div class="section-body">
            <div class="card">
              <div class="card-header">
                <h4>Berita Acara IT Software</h4>
              </div>
              <div class="card-body">
                ...
                <div class="tab-content mt-4" id="baTabContent">
                  ...
                  <div class="tab-pane fade show active" id="buatba" role="tabpanel">
                    <?php if (!empty($berita_acara)): ?>
                      <form method="POST" action="simpan_berita_acara_software.php">
  ...
  <input type="text" class="form-control" value="Akan digenerate otomatis" readonly>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="<?= $berita_acara['kategori']; ?>" readonly>
                          </div>
                          <div class="form-group col-md-6">
                            <label>Kendala</label>
                        ...
                        <div class="d-flex">
                          ...
                          <a href="data_tiket_it_software.php" class="btn btn-secondary">Kembali</a>
                        </div>
                        ...
                        <tbody>
                          ...
                          while ($row = mysqli_fetch_assoc($queryBA)) {
                            echo "<tr>
                                    <td>{$no}</td>
                                    <td>{$row['nomor_ba']}</td>
                                    <td><a href='berita_acara_software.php?tiket_id={$row['tiket_id']}'>{$row['nomor_tiket']}</a></td>
                                    <td>" . date('d-m-Y H:i', strtotime($row['tanggal_ba'])) . "</td>
                                    <td>{$row['kategori']}</td>
                                    <td>{$row['kendala']}</td>
                                    <td><span class='badge badge-success'>Tersimpan</span></td>
                                    <td>
                                      <a href='cetak_berita_acara_software.php?tiket_id={$row['tiket_id']}' target='_blank' class='btn btn-sm btn-primary'>Cetak</a>
                                    </td>
                                  </tr>";
                            $no++;
                          }
