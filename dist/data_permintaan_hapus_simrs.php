...
<meta charset="UTF-8">
<title>Rekap Permintaan Hapus Data SIMRS</title>
...
<h4>📊 Rekap Permintaan Hapus Data SIMRS</h4>
</div>
...
<?php
$statusList = ["Menunggu","Diproses","Ditolak","Selesai"];
...
<a href="data_permintaan_hapus_simrs.php" class="btn btn-secondary">Reset</a>
</div>
</div>
</form>
...
<td class="text-center">
<a href="print_hapus_data.php?id=<?= $r['id'] ?>" target="_blank"
