...
if (isset($_POST['simpan'])) {
    ...
    if (mysqli_query($conn, $query)) {
        ...
        $pesan_telegram  = "<b>📢 TIKET IT HARDWARE</b>\n\n";
      ...
      $row_grup = mysqli_fetch_assoc(mysqli_query($conn, "SELECT nilai FROM wa_setting WHERE nama='wa_group_it' LIMIT 1"));
        ...
        echo "<script>alert('Tiket berhasil disimpan & dikirim ke Telegram & WA. Nomor: $nomor_tiket'); window.location.href='order_tiket_it_hardware.php';</script>";
    } else {
