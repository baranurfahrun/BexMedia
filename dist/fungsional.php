...
$current_file = basename(__FILE__); // nama file sekarang, misal: fungsional.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan'])) {
  ...
  if (!is_numeric($nominal) || $nominal <= 0) {
    ...
    $query = mysqli_query($conn, "INSERT INTO fungsional (nominal) VALUES ('$nominal')");
    if ($query) {
      $_SESSION['flash_message'] = "Data berhasil disimpan.";
      header("Location: fungsional.php");
      exit;
    } else {
...
$data = mysqli_query($conn, "SELECT * FROM fungsional ORDER BY id DESC");
?>
...
<div id="app">
  <div class="main-wrapper main-wrapper-1">
    ...
    <div class="main-content">
      <?php 
      $breadcrumb = "Employee Hub / <strong>Fungsional</strong>";
      include "topbar.php"; 
      ?>
