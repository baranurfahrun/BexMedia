...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan'])) {
  ...
  if (!is_numeric($nominal) || $nominal <= 0) {
    ...
    $query = mysqli_query($conn, "INSERT INTO potongan_dana_sosial (nominal) VALUES ('$nominal')");
    if ($query) {
      $_SESSION['flash_message'] = "Data berhasil disimpan.";
      header("Location: potongan_dana_sosial.php");
      exit;
    } else {
...
$data = mysqli_query($conn, "SELECT * FROM potongan_dana_sosial ORDER BY id DESC");
?>
...
<div id="app">
  <div class="main-wrapper main-wrapper-1">
    ...
    <div class="main-content">
      <?php 
      $breadcrumb = "Employee Hub / <strong>Potongan Dana Sosial</strong>";
      include "topbar.php"; 
      ?>
        ...
        <div class="section-body">
          <div class="card">
            <div class="card-header">
              <h4>Manajemen Potongan Dana Sosial</h4>
            </div>
            <div class="card-body">
                ...
                <div class="tab-pane fade show active" id="input" role="tabpanel">
                  ...
                  <form method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" name="nominal" class="form-control" placeholder="Contoh: 150000" required>
                    </div>
