        ...
        <div class="section-body">
          <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-calendar-alt text-primary mr-2"></i> Laporan Kerja Tahunan</h4>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="tab-content mt-4" id="laporanTabContent">
                ...
                <div class="tab-pane fade show active" id="input" role="tabpanel">
                  <form method="POST" action="simpan_laporan_tahunan.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-3">
                        <label>Jabatan</label>
                        <input type="text" class="form-control" value="<?= $userData['jabatan']; ?>" readonly>
                      </div>
                      <div class="form-group col-md-3">
                        <label>Unit Kerja</label>
                        <input type="text" class="form-control" value="<?= $userData['unit_kerja']; ?>" readonly>
                      </div>
  ...
  <div class="table-responsive-custom mt-3">
    <table class="table table-bordered table-striped table-nowrap">
      ...
      <tbody>
        <?php
        $no = 1;
        $q = mysqli_query($conn, "SELECT * FROM laporan_tahunan WHERE user_id = '$user_id' ORDER BY tahun DESC");
        if (mysqli_num_rows($q) > 0) {
          while ($d = mysqli_fetch_assoc($q)) {
            ...
            if (!empty($d['file_laporan'])) {
              echo "<a href='uploads/laporan_tahunan/{$d['file_laporan']}' target='_blank' class='btn btn-sm btn-secondary'><i class='fas fa-file-download'></i></a>";
            } else {
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
    <form action="update_laporan_tahunan.php" method="POST" enctype="multipart/form-data">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Edit Laporan Tahunan</h5>
