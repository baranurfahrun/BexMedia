...
<div class="ticket">
  ...
  <div class="title">TIKET IT SOFTWARE</div>
...
$canvas->set_opacity(0.07); // transparansi

$imagePath = 'assets/watermark.jpg'; // Sesuaikan dengan lokasi file
if (file_exists($imagePath)) {
    $width = 700;  // ukuran watermark
    $height = 300;
