...
// Hitung total data
$q_total = mysqli_query($conn, "SELECT COUNT(*) as total FROM laporan_tahunan l JOIN users u ON l.user_id = u.id $where_sql");
$total_data = mysqli_fetch_assoc($q_total)['total'];
$total_pages = ceil($total_data / $limit);

// Ambil data paginated
$q = mysqli_query($conn, "SELECT l.*, u.nik, u.nama, u.jabatan, u.unit_kerja 
                          FROM laporan_tahunan l 
...
<head>
  ...
  <meta charset="UTF-8">
  <title>Daftar Laporan Tahunan</title>
        ...
        <div class="section-body">
          <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-calendar-alt text-primary mr-2"></i> Daftar Laporan Tahunan Seluruh Unit</h4>
            </div>
            ...
            <div class="card-body">
              ...
              <form method="GET" class="form-inline mb-4">
                ...
                <select name="tahun" class="form-control mr-3">
                  ...
                  <?php
                  $q_tahun = mysqli_query($conn, "SELECT DISTINCT tahun FROM laporan_tahunan ORDER BY tahun DESC");
              ...
              <div class="table-responsive mt-3">
                <table class="table table-bordered table-striped table-nowrap">
                  ...
                  if (mysqli_num_rows($q) > 0) {
                    ...
                    echo "<tr><td colspan='9' class='text-center'>Belum ada data laporan.</td></tr>";
                  }
                  ?>
                  </tbody>
                </table>
