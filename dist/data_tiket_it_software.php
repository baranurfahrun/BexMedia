              ...
              <div class="card-body">
                <form method="GET" class="form-inline mb-3">
                  <div class="row w-100 align-items-end">
                    ...
                    <div class="col-md-2">
                      <a href="data_tiket_it_software.php" class="btn btn-secondary w-100">Reset</a>
                    </div>
                  </div>
                </form>
                ...
                $totalQuery = mysqli_query($conn, "SELECT COUNT(*) as total FROM tiket_it_software t JOIN users u ON t.user_id = u.id $where");
